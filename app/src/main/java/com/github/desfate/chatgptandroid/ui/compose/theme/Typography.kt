...
// 使用 Google Fonts 的凭据初始化 GoogleFont.Provider  请注意，您需要添加 ExperimentalTextApi 注解，才能在应用中使用可下载字体 API。
@OptIn(ExperimentalTextApi::class)
val provider = GoogleFont.Provider(
    providerAuthority = "com.google.android.gms.fonts",  //     Google Fonts 的字体提供程序授权
    providerPackage = "com.google.android.gms",  //             用于验证提供程序身份的字体提供程序软件包
    certificates = R.array.com_google_android_gms_fonts_certs// 用于验证提供程序身份的一系列证书哈希集。您可以在 JetChat 示例应用的 font_certs.xml 文件中找到 Google Fonts 提供程序所需的哈希。
)
